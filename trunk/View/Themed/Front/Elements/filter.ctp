<form method="get" action="/filters" id="detailsearch">
		<div id="calarea">
...
?>
			...
			?>
				<option name=""value="<?php echo $key?>" <?php 
	...
	<div id="calcate">
		...
		<select name="data[cat]">
			...
			<?php foreach ($categories as $key => $cat) : ?>
				...
				if(isset($postdata['cat']) && $postdata['cat'] !== ""){
						if($postdata['cat'] == $key){
	...
	<div id="submit_detail">
		<input type="image" src="/theme/Front/img/s_btn.jpg" alt="検索" id="search_btn_l" class="fix-margin-left filter_submit">
	</div>
</form>
