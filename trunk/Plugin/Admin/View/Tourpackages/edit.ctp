<div class="portlet box purple ">
	...
	<?php } ?>
			...
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-md-9">
						...
						<option value="default" selected="">▼主催者</option>
						<?php 
						
						
							foreach ($sponsors as $key => $sponsor) {
							
							if($sponsorid == $key){$sel = 'selected';}else{$sel = "";}
							
							echo "<option value='".$key."'".$sel.">".$sponsor."</option>";
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						...
						<?php foreach ($areas as $key => $area) {
							if($areaid==$key){$sel="selected";}else{$sel="";}
							echo "<option value='".$key."'".$sel.">".$area."</option>";
		...
		<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<?php 
						if($featured == "1"){$def = "1";}else{$def = '0';}
							$is_featured = array(
									'0' => 'No',
									'1' => 'Yes',
								);
			  ...
			  <div class="form-group">
					...
					<div class="col-md-9">
						...
						?>
									...
									<label class="col-md-3 control-label">現在アップロードされているPDF</label>
						   	<div class="col-md-9">
						<?php 
							echo $this->Form->input('pdfname', array(
							'label' => false,
							'div' => '', 
							'readonly' => 'readonly',
							'class' => 'form-control')) 
						?>
									...
									<label class="col-md-3 control-label">現在アップロードされているPDFの削除</label>
						   	<div class="col-md-9">
						<?php 
							echo $this->Form->input('delpdf', array(
							'label' => false,
							'type' => 'checkbox', 
							'div' => 'PDF削除', 
							'class' => 'form-control')) 
    ...
    'name' => 'preview')); ?>
				...
				<button type="submit" name="submit" class="btn green">更新</button>
			</div>
